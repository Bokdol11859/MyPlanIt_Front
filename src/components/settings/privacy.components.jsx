...
1. 이 개인정보처리방침은 2022년 5월 1부터 적용됩니다.
2. 마이플랜잇의 제공 서비스는 https://myplanit.site 와 직접 연동되어 온라인에서 이용 가능한 서비스입니다.
3. 마이플랜잇은 개인정보 처리 방침은 제공 서비스(https://www.myplanit.site)와 마이플랜잇 홈페이지(https://www.myplanit-home.site)에 모두 공개함으로써 회원이 쉽게 볼 수 있도록 조치하고 있습니다.
...
2. 맞춤형 회원 서비스 제공 : 신규 서비스(플랜) 개발, 이접속빈도 파악 또는 회원의 서비스 이용에 대한 통계, 결제 및 정산을 목적으로 개인정보를 처리합니다.
3. 마케팅 및 광고에의 활용 : 이벤트 및 광고성 정보 제공 및 참여기회 제공을 목적으로 개인정보를 처리합니다.
4. 통계작성, 과학적 연구, 공익적 기록보존 등을 위한 가명정보 처리 : 수집한 개인정보를 개인을 알아볼 수 없는 통계자료 등으로 가공하여 이용 및 제공을 목적으로 개인정보를 처리합니다.
...
1. 통신 사실 확인자료 제공시 필요한 가입자의 전기통신 일시, 전기통신 개시종료시간, 통신번호 등 상대방의 가입자번호, 사용초, 통신신망에 접속된 정보통신기기의 위치추적자료 : 12개월(통신비밀보호법)
...
1. Amazon Web Services Inc.
 ...
 위탁하는 업무의 내용 : 데이터 보관
2. Google, Facebook
 위탁받는 자 (수탁자) : Google, Facebook
 위탁하는 업무의 내용 : 맞춤형 광고 제공
 위탁기간 : 2년
...
(1) 정보주체는 마이플랜잇에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
(2) 제1항에 따른 권리 행사는마이플랜잇에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 마이플랜잇은 이에 대해 지체 없이 조치하겠습니다.
...
3. 내부관리계획의 수립 및 시행 : 개인정보의 안전한 처리를 위하여 내부관리계획을 수립하고 시행하고 있습니다. 마이플랜잇은 이용자 개인의 실수나 기본적인 인터넷의 위험성 때문에 일어나는 일들에 대해 책임을 지지 않습니다.
4. 해킹 등에 대비한 기술적 대책 : 마이플랜잇은 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을 막기 위하여 보안프로그램을 설치하고 주기적인 갱신·점검을 하며 외부로부터 접근이 통제된 구역에 시스템을 설치하고 기술적/물리적으로 감시 및 차단하고 있습니다.
...
6. 접속기록의 보관 및 위변조 방지 : 개인정보처리시스템에 접속한 기록을 관계법령에서 요구하는 기간 동안 보관, 관리하고 있으며, 접속 기록이 위변조 및 도난, 분실되지 않도록 보안기능을 사용하고 있습니다.
...
1. 개인정보 보호책임자 : 이수진 개발팀장 / sssssjin99@naver.com
2. 개인정보 보호담당자 : 이명성 대표 / lms961213@naver.com
(2) 정보 주체께서는 마이플랜잇의 서비스를 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자에게 문의하실 수 있습니다. 마이플랜잇은 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.
...
이 개인정보처리방침은 2022년 5월 1부터 적용됩니다.</pre
>`;
  return (
    <>
      <Styled.Header>
